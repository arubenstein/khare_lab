...
af_path=/home/arubenstein/mean_field/xtal_pdbs/
...
then
	...
	catcst='-enzdes::cstfile '$af_path'/'$pdb'cstfile.txt'
        score=enzdes
	flags=/home/arubenstein/mean_field/pdbs/ancillary_files/enzflags
fi
...
do
	...
	nohup nice /home/arubenstein/Rosetta/main/source/bin/rosetta_scripts.static.linuxgccrelease -nstruct 1  -parser:protocol /home/arubenstein/mean_field/xml'/'$xml -database /home/arubenstein/Rosetta/main/database/ $extra_res_fa -out::prefix Cstscored_ -l $path'/Job_'${i}'/list'  -run:preserve_header $catcst @$flags -overwrite -score:weights $score > cst.log &
